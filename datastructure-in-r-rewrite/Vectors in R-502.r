...
vector_2<-rep(1:12)
vector_3<-seq(from = 2, to = 5.5, by = 0.25)
...
new_is_stem_classes_end <- c(is_stem_classes,is_stem_classes )
new_is_stem_classes_start <-c(extra_is_stem_classes,is_stem_classes_classes )
